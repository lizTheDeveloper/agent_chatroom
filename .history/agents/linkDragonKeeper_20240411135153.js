...
const client = new OpenAI(base_url="http://localhost:1234/v1", model = "NousResearch/Hermes-2-Pro-Mistral-7B-GGUF/Hermes-2-Pro-Mistral-7B.Q4_0.gguf",api_key="lm-studio")
