...
class retrieveLinkFromDatabase {
    ...
    async generateValuesWithAI(data) {
        const systemPrompt = `A user has made a request: "${userQuery}". First, determine whether this is a request to  Generate a SQL query  following: title, content summary, link name, uploaded by, upload date, tags.`;
