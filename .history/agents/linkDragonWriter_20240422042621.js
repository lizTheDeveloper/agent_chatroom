...
const interactionData = {
    ...
    link: '', // link mentioned in the message (if any)
    intent: '', // intent of the user's request (if applicable)
    model: 'NousResearch/Hermes-2-Pro-Mistral-7B-GGUF/Hermes-2-Pro-Mistral-7B.Q4_0.gguf', // AI model to use
    format: '' // optional, for specifying the return format
  };
instance.post('/chat/completions', data)
    .then(response => {
