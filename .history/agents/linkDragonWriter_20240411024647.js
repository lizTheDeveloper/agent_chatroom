...
let intro_message = "hey, you just sent me a link for the first time! i'm Link Dragon, a bot to help you keep track of your links and even query web content. just mention me with @LinkDragon and let me know how i can help you. you can also send @LinkDragonHelp for a list of available features."

let help_message = "hey! here's a few send any link in the chat, and Link Dragon will pick it up. the links get stored under your username, so just " +
...
agent.registerMessageHandler("general", async function (msg) {
    ...
    if (msg.includes("@LinkDragon".toLowerCase)) {
