...
const { handleReceivedLink } = require('./linkDragonScribe.js');
const client = new OpenAI(base_url="http://192.168.1.178:1234/v1", api_key="lm-studio")


require('dotenv').config();

let allowedUsers = "gen3, thisisgene, pleasehelp"
//creating new agent
...
async function linkDragonMentioned(message) {
    ...
    // add in a "recent links" to pull just the basic data no parsing
