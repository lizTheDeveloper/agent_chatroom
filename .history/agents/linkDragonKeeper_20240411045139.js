...
class retrieveLinkFromDatabase {
    ...
    async generateValuesWithAI(data) {
        ...
        // ai should follow the syntax of the data object according to user request: retrieval from normal sql database if straight recall, or from vector database if query
